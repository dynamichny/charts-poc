...
import { red, violet, green } from '../../constants/colors';
...
const Chart = ({ size }: { size: { width: number; height: number } }) => {
  ...
  return (
    <View>
      ...
      <CurrentPositionVerticalLine color={violet[60]} length={size.height} />
      <OpeningPositionHorizontalLine color={violet[60]} length={size.width} />
    </View>
  );
};
